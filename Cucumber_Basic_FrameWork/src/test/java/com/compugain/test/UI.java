...
@CucumberOptions(strict = false,features = {Setup.sAMAZONCOM },  format = { "pretty","html:target/site/cucumber-pretty","html:target/cucumber-html-report", "json:target/cucumber.json" }, monochrome = false)
